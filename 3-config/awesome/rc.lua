...
awful.key({ modkey }, "F9", function ()
            ...
            --   screen_1.mybottomwibox.visible = not screen_1.mybottomwibox.visible
			end,
         {description = "toggle wibox and bottom_wi_box on screen 1", group = "awesome"}),
...
-- Show/Hide Wibox on screen 2
     ...
     awful.key({ modkey }, "F10", function ()
             ...
             --  screen_2.mybottomwibox.visible = not screen_2.mybottomwibox.visible
			end,
         {description = "toggle wibox and bottom_wi_box on screen 2", group = "awesome"}),
...
awful.spawn.with_shell("/usr/bin/lxsession") 
